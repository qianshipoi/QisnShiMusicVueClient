<template>
  <div class="control-bar">
    <img src="https://oss.kuriyama.top/static/akua.png"
         style="width:4rem; height: 4rem; border-radius: 0.75rem;"
         alt="封面">
    <n-space class="buttons">
      ...
      <n-button tertiary
                :color="themeVars.primaryColor"
                size="large"
                @click="playOrPauseClick"
                circle>
        <template #icon>
          <n-icon :size="28"
                  :component="playPauseButtonIcon">
          </n-icon>
        </template>
      </n-button>
      <n-button tertiary
        ...
        <template #icon>
          <n-icon :size="22"
                  :component="PlaySkipForward">
          </n-icon>
        </template>
      </n-button>
      <n-slider style="width:20rem;"
      ...
      <n-slider style="width:6rem;margin: 10px;"
...
const playPauseButtonIcon = shallowRef(Play)
watchEffect(() => {
