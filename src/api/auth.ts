 ...
 */
export function loginWithPhone(params: { phone?: number, password?: string, countrycode?: number, md5_password?: string }) {
  return request({
    url: '/login/cellphone',
    method: 'post',
    params,
 ...
 * @param {string=} params.md5_password
 */
export function loginWithEmail(params: { email?: number, password?: string, md5_password?: string }) {
  return request({
    url: '/login',
    method: 'post',
    params,
